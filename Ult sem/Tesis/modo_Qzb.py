from Tesis.Cinematica_Inversa import Cinematica_Inversa_3R
...
vx = 0
vy = 0
q0 = Cinematica_Inversa_3R(qx, qy)
qdot0 = funcion(vx, vy, jaco[0:2, :])
normalizado = espacio_N_Normali(matriz_nula_cargada, m3)

qzb1,qrb,qtbdot = qzb(q0, qdot0, normalizado, m3)
sp.pprint(qzb1)
x0=qrb[0:2,:].col_join(qtbdot[0:2,:])
sp.pprint(x0)
